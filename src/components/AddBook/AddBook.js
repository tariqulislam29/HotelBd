...
const AddBook = () => {
    ...
    const onSubmit = data => {
        console.log(data);
        axios.post('https://ghoulish-vampire-97561.herokuapp.com/rooms', data)
            .then(res => {
    ...
    return (
        <div className="add-details">
            ...
            <div className="add-selects">
                <h2 className="text-center">Please Add a Booking Room</h2>
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="col my-3">
                        <textarea className="input-field1" rows="4" cols="50" {...register("full_description")} placeholder="Full Description" />
                    </div>
                    <div className="col my-3">
